...
; *******************************************************************
	...
	#include "p18f452.inc"		; Processor include file
...
Task1	
	nop
	nop
	btg	LATB,5			;Bit Toggle PortB <5>
	nop
	swptsk				; Force the TM to swap


	btg	LATB,7			;Bit Toggle PortB <7>
	btg	LATB,6			;Bit Toggle PortB <6>
	nop	
